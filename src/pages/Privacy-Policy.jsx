  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center relative overflow-hidden">
      ...
      <Link to="/"> 
            ...
            <h1 className="text-3xl font-semibold text-blue-700 text-center">Privacy Policy</h1>
          </div>
      </header>
      <main className="container mx-auto lg:m-4 p-6 lg:p-8 bg-white bg-opacity-70 shadow-md mt-[-1%] rounded-lg max-w-4xl relative z-10 backdrop-filter backdrop-blur-lg border border-gray-200 text-justify">
        <section>
