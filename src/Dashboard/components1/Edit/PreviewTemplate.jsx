...
const PreviewTemplate = () => {
  ...
  const { image, json, productID } = location.state || {}; // Extract productID from state
    ...
    >
      {image ? (
        <div className="relative w-full h-full max-w-screen-lg flex justify-center">
          ...
          <button
            onClick={() =>
              navigate(`/edit_template?id=${productID}`, {
                state: { json, productID }, // Pass the JSON and productID back
              })
            }
