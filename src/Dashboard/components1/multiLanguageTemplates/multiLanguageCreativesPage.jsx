...
import MultiLanguageCreatives from './multiLanguageCreatives';

const MultiLanguageCreativesPage = () => {
                ...
                <div className="flex flex-col min-h-screen">
                    ...
                    <div className="flex flex-grow">
                        ...
                        <div className={`flex-grow transition-transform duration-300 ${isSidebarOpen ? '-ml-6' : 'ml-0'}`} >
                            <div className='m-2' ><MultiLanguageCreatives /></div>
                        </div>
                    </div>
                </div>
            </div>
...
export default MultiLanguageCreativesPage;
