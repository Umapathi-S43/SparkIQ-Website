...
export default function CustomizationAd({
  isLoading,
  setIsLoading,
  setPage,
  ...
  return (
    <div className=" max-w-6xl container lg:mb-4 sm:mx-auto mb-4 lg:p-0 sm:p-4 overflow-auto hide-scrollbar" >
      <div className="border border-white rounded-[32px] flex flex-col gap-6 relative z-10 w-full">
        <div
          className="flex justify-between items-center bg-[rgba(252,252,252,0.40)] rounded-t-[32px] lg:p-6 p-4 sm:p-4 relative w-full max-w-full"
        >
        ...
        <div className="overflow-auto mb-8 ml-6 hide-scrollbar"style={{maxHeight:'55vh'}} >
          {isLoading ? (
            <div className="w-full py-8 justify-center ">
              <Loader />
            </div>
          ) : (
