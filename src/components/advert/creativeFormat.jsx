          ...
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
            {aiSuggestions.map((suggestion, idx) => (
              ...
              >
                ...
                {selectedSuggestions === suggestion.title && (
                  <div className="absolute top-2 right-2 w-6 h-6 rounded-full bg-green-500 flex items-center justify-center shadow">
                    <FaCheck className="text-white text-sm" />
                  </div>
                )}
            ...
            <div className="pt-4 grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
              {displayedSizes.map((item, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className={`flex flex-col items-center justify-center gap-2 w-full py-4 rounded-[20px] shadow cursor-pointer ${selectedSize === cleanedSize ? "bg-[#00A0F5] text-white" : "bg-white"
                      }`}
