    ...
    <div className="w-full mb-10 font-roboto p-6">
      ...
      <div className="flex flex-wrap justify-center gap-4 my-4">
        <img
          src={thub}
          alt="T-HUB"
          className="w-38 h-38 transform transition-transform duration-500 hover:scale-110 m-2"
        />
        <img
          src={math}
          alt="Math Logo"
          className="w-64 h-70 transform transition-transform duration-500 hover:scale-110 m-2"
        />
        <img
          src={blitz}
          alt="Blitz"
      ...
      <p className="lg:text-justify lg:px-3 lg:py-4 lg:text-xl text-md text-center">
        ...
        collaborative partnership between the Government of Telangana, three
        premier academic institutes in Hyderabad, and the private sector.
      </p>
    </div>
  );
}
