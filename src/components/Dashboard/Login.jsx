    ...
    <div className="flex items-center justify-end min-h-screen bg-gradient-to-b from-[#B3D4E5] to-[#D9E9F2] px-4 lg:pr-40">
      <div className="flex flex-col items-center w-full max-w-md p-4">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          <div className="w-full p-8 rounded-3xl shadow-md border border-white" style={{ background: 'rgba(255,255,255,0.30)' }}>
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-blue-600 text-center cursor-pointer">Forgot password?</p>
            </div>
          </div>
          <div className="flex justify-center mt-4">
            <button type="submit" className="custom-button p-2 pl-6 pr-6 text-white  border-[#FCFCFC] rounded-lg shadow-2xl flex justify-center w-fit">
              Login
            </button>
          </div>
        </form>
